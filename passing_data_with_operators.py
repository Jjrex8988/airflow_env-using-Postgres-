# nano ~/airflow/dags/passing_data_with_operators.py
...
def display_result(**kwargs):
    ...
    averagee = ti.xcom_pull(
        task_ids='compute_average', key='average_price'
    )

    print("Total price of good {total}".format(total=totall))
    print("Average price of good {average}".format(average=averagee))
